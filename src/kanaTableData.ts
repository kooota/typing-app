...
const YOON_SPECS: CellSpec[] = [
  ...
  { row: 1, col: 0, kana: "しゃ", romaji: "sya" },
  { row: 1, col: 1, kana: "しゅ", romaji: "syu" },
  { row: 1, col: 2, kana: "しょ", romaji: "syo" },
  { row: 2, col: 0, kana: "ちゃ", romaji: "tya" },
  { row: 2, col: 1, kana: "ちゅ", romaji: "tyu" },
  { row: 2, col: 2, kana: "ちょ", romaji: "tyo" },
  ...
  { row: 8, col: 0, kana: "じゃ", romaji: "zya" },
  { row: 8, col: 1, kana: "じゅ", romaji: "zyu" },
  { row: 8, col: 2, kana: "じょ", romaji: "zyo" },
